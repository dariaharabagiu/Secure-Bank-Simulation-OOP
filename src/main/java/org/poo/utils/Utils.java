...
public final class Utils {
    ...
    /**
     * Validates whether the given IBAN is in the correct format.
     *
     * @param iban The IBAN to be validated.
     * @return {@code true} if the IBAN matches the specified format, {@code false} otherwise.
     */
    public static boolean isValidIBAN(final String iban) {
        String regex = "^[A-Z]{2}\\d{2}[A-Z]{4}\\d{16}$";
